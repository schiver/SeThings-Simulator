...
public class Bedroom1Fragment extends Fragment {
    ...
    TextView laptopStatus,laptopLabelText1,laptopLabelText2,laptopLabelText3;
    TextView tvStatus,tvLabelText1,tvLabelText2,tvLabelText3;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.bedroom_fragment,container,false);
        ...
        laptopStatus = rootView.findViewById(R.id.textView24);
        laptopLabelText1 = rootView.findViewById(R.id.textView26);
        laptopLabelText2 = rootView.findViewById(R.id.time_start4);
        laptopLabelText3 = rootView.findViewById(R.id.time_start5);
        tvStatus = rootView.findViewById(R.id.textView30);
        tvLabelText1 = rootView.findViewById(R.id.textView31);
        tvLabelText2 = rootView.findViewById(R.id.time_start6);
        tvLabelText3 = rootView.findViewById(R.id.time_start7);
        setDefault();
    ...
    public void setDefault(){
        ...
        tvLabelText1.setText("");
        tvLabelText2.setText("");
        tvLabelText3.setText("");
        laptopLabelText1.setText("");
        laptopLabelText2.setText("");
        laptopLabelText3.setText("");
    ...
    public void onResume() {
        ...
        dbRef = myDb.getReference("SeThings-Config/Bedroom 1/Dev-01");
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!myConfig.getDeviceCondition().equals("#")){
                    ...
                    dbConditionRef = myDbCondition.getReference("SeThings-Detail_Config/Bedroom 1/Dev-01");
                    dbConditionRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if(myConfig.getGetDeviceConditionConnected().equals("#")){
                                if(myDetailConfig.getDevCondition().equals("TIMER")){
                                    ...
                                    myTimer = new CountDownTimer(Integer.parseInt(myDetailConfig.getDevConditionTimerDuration())*1000,1000){
                                        ...
                                        public void onFinish() {
                                            ...
                                            updateConfigOff("Bedroom 1","Dev-01");
                                            //myCounter = 0;
                                        }
                                    }.start();
                                    //mTimer = true;
                                ...
                                DatabaseReference dbConnectRef = connectDB.getReference("SeThings-Sensors/Bedroom 1/");
                    ...
                    updateDataUsage("Bedroom 1","Dev-01",20,myCounter);
                    updateConfigOff("Bedroom 1","Dev-01");
        ...
        dbRef2 = myDb2.getReference("SeThings-Config/Bedroom 1/Dev-02");
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!myConfig.getDeviceCondition().equals("#")){
                    // Dilakukan Config
                    myDbCondition = FirebaseDatabase.getInstance();
                    dbConditionRef = myDbCondition.getReference("SeThings-Detail_Config/Bedroom 1/Dev-02");
                    dbConditionRef.addValueEventListener(new ValueEventListener() {
                        @RequiresApi(api = Build.VERSION_CODES.N)
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if(myDetailConfig.getDevCondition().equals("TIMER")){
                                    ...
                                    myTimer2 = new CountDownTimer(Integer.parseInt(myDetailConfig.getDevConditionTimerDuration())*1000,1000){
                                        ...
                                        public void onFinish() {
                                            ...
                                            updateConfigOff("Bedroom 1","Dev-02");
                                            //myCounter2 = 0;
                                        }
                                    }.start();
//                                    /mTimer = true;
                    ...
                    myTimer2.cancel();
                    updateDataUsage("Bedroom 1","Dev-02",75,myCounter2);
                    updateConfigOff("Bedroom 1","Dev-02");
                    //Toast.makeText(getContext(),"Counter : "+myCounter,Toast.LENGTH_SHORT).show();
                    //updateDataUsage("Livingroom","Dev-03",20,myCounter);
                    //updateConfigOff("Livingroom","Dev-03");
        ...
        dbRef3 = myDb3.getReference("SeThings-Config/Bedroom 1/Dev-03");
        dbRef3.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!myConfig.getDeviceCondition().equals("#")){
                    // Dilakukan Config
                    myDbCondition = FirebaseDatabase.getInstance();
                    dbConditionRef = myDbCondition.getReference("SeThings-Detail_Config/Bedroom 1/Dev-03");
                    dbConditionRef.addValueEventListener(new ValueEventListener() {
                        @RequiresApi(api = Build.VERSION_CODES.N)
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if(myDetailConfig.getDevCondition().equals("TIMER")){
                                    ...
                                    myTimer3 = new CountDownTimer(Integer.parseInt(myDetailConfig.getDevConditionTimerDuration())*1000,1000){
                                        ...
                                        public void onTick(long millisUntilFinished) {
                                            ...
                                            long hour = (millisUntilFinished / (1000 * 60 * 60)) % 24;
                                            String displayTime = "  "+hour+" Hour "+minute+" Min "+second+" Sec";
                                            laptopStatus.setText("On");
                                            laptopLabelText1.setVisibility(View.VISIBLE);
                                            laptopLabelText1.setText(displayTime);
                                            myCounter3+=1;
                                        }
                                        @Override
                                        public void onFinish() {
                                            laptopStatus.setText("Off");
                                            laptopLabelText1.setVisibility(View.GONE);
                                            //updateDataUsage("Livingroom","Dev-04",75,myCounter2);
                                            updateConfigOff("Bedroom 1","Dev-03");
                                            //myCounter2 = 0;
                                        }
                                    }.start();
                                    //mTimer = true;
                    ...
                    myTimer3.cancel();
                    updateDataUsage("Bedroom 1","Dev-03",65,myCounter3);
                    updateConfigOff("Bedroom 1","Dev-03");
                    //Toast.makeText(getContext(),"Counter : "+myCounter,Toast.LENGTH_SHORT).show();
                    //updateDataUsage("Livingroom","Dev-03",20,myCounter);
                    //updateConfigOff("Livingroom","Dev-03");
        ...
        dbRef4 = myDb4.getReference("SeThings-Config/Bedroom 1/Dev-04");
        dbRef4.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!myConfig.getDeviceCondition().equals("#")){
                    // Dilakukan Config
                    myDbCondition = FirebaseDatabase.getInstance();
                    dbConditionRef = myDbCondition.getReference("SeThings-Detail_Config/Bedroom 1/Dev-04");
                    dbConditionRef.addValueEventListener(new ValueEventListener() {
                        @RequiresApi(api = Build.VERSION_CODES.N)
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if(myDetailConfig.getDevCondition().equals("TIMER")){
                                    ...
                                    myTimer4 = new CountDownTimer(Integer.parseInt(myDetailConfig.getDevConditionTimerDuration())*1000,1000){
                                        ...
                                        public void onTick(long millisUntilFinished) {
                                            ...
                                            String displayTime = "  "+hour+" Hour "+minute+" Min "+second+" Sec";
                                            tvStatus.setText("On");
                                            tvLabelText1.setVisibility(View.VISIBLE);
                                            tvLabelText1.setText(displayTime);
                                            myCounter4+=1;
                                        }
                                        @Override
                                        public void onFinish() {
                                            tvLabelText1.setText("Off");
                                            tvLabelText1.setVisibility(View.GONE);
                                            //updateDataUsage("Livingroom","Dev-04",75,myCounter2);
                                            updateConfigOff("Bedroom 1","Dev-04");
                                            //myCounter2 = 0;
                                        }
                                    }.start();
                                    //mTimer = true;
                    ...
                    myTimer4.cancel();
                    updateDataUsage("Bedroom 1","Dev-04",75,myCounter4);
                    updateConfigOff("Bedroom 1","Dev-04");
                    //Toast.makeText(getContext(),"Counter : "+myCounter,Toast.LENGTH_SHORT).show();
                    //updateDataUsage("Livingroom","Dev-03",20,myCounter);
                    //updateConfigOff("Livingroom","Dev-03");
